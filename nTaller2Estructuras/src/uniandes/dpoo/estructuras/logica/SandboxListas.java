...
public class SandboxListas
{
    ...
    {
    	java.util.Iterator<Integer> iterator = listaEnteros.iterator();
    ...
    {
    	java.util.Iterator<String> iterator = listaCadenas.iterator();
    	while(iterator.hasNext()) {
    ...
    {
    	java.util.Set<Integer> unicos = new java.util.HashSet<>();
    	java.util.Set<Integer> repetidos = new java.util.HashSet<>();
